...
DATA_DIR = os.path.join(BASE_DIR, "data", "raw_files", "edelweiss")
LOG_DIR = os.path.join(BASE_DIR, "logs", "scraper_logs")

os.makedirs(LOG_DIR, exist_ok=True)
os.makedirs(DATA_DIR, exist_ok=True)

LOG_FILE = os.path.join(LOG_DIR, "edelweiss_scraper.log")
...
if __name__ == "__main__":
    ...
    logger.info("Starting Edelweiss folder structure setup")

    folders = create_month_folders()

    validate_files(folders)

    logger.info("Edelweiss validation completed")