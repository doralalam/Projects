...
LOG_FILE = os.path.join(LOG_DIR, "icici_prudential_scraper.log")
...
if __name__ == "__main__":
    ...
    logger.info("Starting ICICI Prudential folder structure setup")

    folders = create_month_folders()

    validate_files(folders)

    logger.info("ICICI Prudential validation completed")