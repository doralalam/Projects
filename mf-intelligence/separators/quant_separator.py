...
RAW_PATH = "/Users/dorababulalam/GitHub/Projects/mf-intelligence/data/raw_files/quant_scraped"
OUTPUT_PATH = "/Users/dorababulalam/GitHub/Projects/mf-intelligence/data/separated_files/quant"
...
def setup_logging():
    ...
    log_file = os.path.join(LOG_PATH, "quant_separator.log")
...
def main():
    ...
    logging.info("Starting Quant sync")
