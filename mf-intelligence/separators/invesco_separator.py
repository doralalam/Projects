...
RAW_PATH = "/Users/dorababulalam/GitHub/Projects/mf-intelligence/data/raw_files/invesco_scraped"
OUTPUT_PATH = "/Users/dorababulalam/GitHub/Projects/mf-intelligence/data/separated_files/invesco"
...
def setup_logging():
    ...
    log_file = os.path.join(LOG_PATH, "invesco_separator.log")
...
def main():
    ...
    logging.info("Starting Invesco sync")
