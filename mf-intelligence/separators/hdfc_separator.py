...
RAW_PATH = "/Users/dorababulalam/GitHub/Projects/mf-intelligence/data/raw_files/hdfc_scraped"
OUTPUT_PATH = "/Users/dorababulalam/GitHub/Projects/mf-intelligence/data/separated_files/hdfc"
...
def setup_logging():
    ...
    log_file = os.path.join(LOG_PATH, "hdfc_separator.log")
...
def main():
    ...
    logging.info("Starting HDFC sync")
