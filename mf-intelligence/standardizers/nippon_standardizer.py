...
def process_file(file_path):
    ...
    df_filtered = df_filtered.loc[~df_filtered[stock_col].astype(str).str.rstrip().str.endswith(("**", "**#"))].copy()
    ...
    fund = re.sub(r"^Nippon India\s+", "", fund_full)
    fund = re.sub(r"_.*$", "", fund)
    ...
    out = out.assign(amc="Nippon", fund=fund, month=month, year=year)
