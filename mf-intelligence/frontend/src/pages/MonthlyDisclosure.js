            ...
            {sortedData.map((row, i) => {
              ...
              return (
                <tr key={i} style={{ borderBottom: "1px solid #e0e0e0" }}>
                  <td style={{ position: "sticky", left: 0, backgroundColor: "#fff", padding: "4px 12px", whiteSpace: "nowrap", fontWeight: 700, borderRight: "2px solid #ccc", zIndex: 5, boxShadow: stickyShadow }}>
                    ...
                    {(isTopPositive || isTopNegative) && (
                      <span style={{
                        ...
                        fontSize: 11,
                        fontWeight: 600,
                        color: isTopPositive ? "green" : "red",
                        backgroundColor: isTopPositive ? "#e6f9e6" : "#ffe6e6",
                        padding: "2px 4px",
                        borderRadius: 4
                      }}>
                  ...
                  <td style={{ position: "sticky", left: 0, zIndex: 4, backgroundColor: "#fff", fontSize: 12, padding: "4px 8px", width: 60, whiteSpace: "nowrap", borderRight: "2px solid #ccc", transform: `translateX(${scrollLeft > 0 ? -Math.min(scrollLeft, 60) : 0}px)`, transition: "transform 0.2s", boxShadow: stickyShadow }}>
                    {row.sector}
                  </td>
...
export default MonthlyDisclosure;